// Complete Plant Monitoring System with Camera - STANDALONE VERSION
// All credentials included in this file
// ⚠️ DO NOT PUSH THIS FILE TO GITHUB - use complete_system_with_camera.ino instead
//
// ESP8266 for sensors + XIAO ESP32S3 for camera
// This version runs on ESP8266 (sensors + telegram commands)
// Upload esp32cam_plant_identify_standalone.ino separately to XIAO ESP32S3
...
const char* plantIdApiKey = "YOUR_PLANT_ID_API_KEY";  // get from https://plant.id
// ==================================================
